...
import publicPaymentRoute from "./routers/payment.public.route.js"; // PUBLIC payment routes (guest checkout)
...
app.use("/api/public", publicPaymentRoute); // PUBLIC payment routes (guest checkout)
